...
class Solver
  ...
  def solve_yellow_cross
    until @cube['y'][@edges[0]] == 'y' && @cube['y'][@edges[1]] == 'y' && @cube['y'][@edges[2]] == 'y' && @cube['y'][@edges[3]] == 'y'
      if @cube['y'][@edges[0]] != 'y' && @cube['y'][@edges[1]] != 'y' && @cube['y'][@edges[2]] != 'y' && @cube['y'][@edges[3]] != 'y'
        orientate_cross
      elsif @cube['y'][1] == 'y' && @cube['y'][3] == 'y' && @cube['y'][5] != 'y' && @cube['y'][7] != 'y'
        orientate_cross
      elsif @cube['y'][3] == 'y' && @cube['y'][5] == 'y' && @cube['y'][1] != 'y' && @cube['y'][7] != 'y'
        orientate_cross
      else
        rotate('y', false)
      end
  ...
  def solve_yellow_corners
    until @cube['y'] == ['y', 'y', 'y', 'y', 'y', 'y', 'y', 'y', 'y']
      if @cube['y'][0] != 'y' && @cube['y'][2] != 'y' && @cube['y'][6] != 'y' && @cube['y'][8] != 'y'
        orientate_corners
      elsif @cube['y'][6] == 'y' && @cube['y'][2] == 'y' && @cube['y'][0] != 'y' && @cube['y'][8] != 'y'
        orientate_corners
      elsif @cube['y'][0] == 'y' && @cube['y'][2] == 'y' && @cube['y'][6] != 'y' && @cube['y'][8] != 'y'
        orientate_corners
      elsif @cube['y'][6] == 'y' && @cube['y'][0] != 'y' && @cube['y'][2] != 'y' && @cube['y'][8] != 'y'
        orientate_corners
      else
        rotate('y', false)
      end
  ...
  def orientate_yellow_corners_algorithm
    rotate('r', true)
    rotate('b', false)
    rotate('r', true)
    rotate('g', false)
      ...
      if @cube['r'][0] != @cube['r'][1] && @cube['r'][1] != @cube['r'][2]
        if @cube['g'][0] != @cube['g'][1] && @cube['g'][1] != @cube['g'][2]
          if @cube['o'][0] != @cube['o'][1] && @cube['o'][1] != @cube['o'][2]
            orientate_yellow_corners_algorithm
          end
        end
      end
    end
  ...
  def solve
    ...
    @step = 14
    orientate_yellow_edges
    @step = 15
    orientate_yellow_corners
    @step = 16
